...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        listarRegistros(db);
        atualizarRegistro(db, "Item1", "Articuno", "Um lendário pokémon de gelo!");
        atualizarRegistro(db, "Item2", "Zapdos ", "Um lendário pokémon elétrico!");
        atualizarRegistro(db, "Item3", "Moltres", "Um lendário pokémon de fogo! ");
